...
def get_random_hp(constants):
    ...
    hidden_dims_len = rand.randrange(hidden_dims_len_range[0], hidden_dims_len_range[1], 1)
    hidden_dims = [rand.randrange(hidden_dims_values_range[0], hidden_dims_values_range[1], 10) for i in range(hidden_dims_len)]
    activation_fcn = rand.choice(activation_fcn_choices)
    lr = 10**rand.randrange(lr_exponent_range[0], lr_exponent_range[1], 1)
